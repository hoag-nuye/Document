...
found_agent = Agent(
    name="Found Agent",
    instructions="hãy là chuyên gia về bảo mật an toàn thông tin : trả lời câu hỏi sau cùng với các đáp án lựa chọn của nó, chỉ đưa ra đáp án và không giải thích gì thêm",
    model=GROQ_LLM_MODEL,
)
